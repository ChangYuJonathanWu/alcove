                ...
                {!pageLoading && <Stack alignItems="center" spacing={1}>
                    <div style={{ borderStyle: 'solid', maxWidth: "350px", borderWidth: '1px', borderColor: 'white', minWidth: '200px', minHeight: '300px', padding: '2em 1em 3em 1em', marginTop: '3em' }}>
                        ...
                        <Stack alignItems={"center"}>
                            <Typography variant="h3" style={{ color: 'white', fontWeight: 700, marginBottom: '1em' }}>{`Hey @michekke, you're in!`}</Typography>
                            ...
                            <Typography variant="subtitle1" style={{color: 'white', marginTop: '3rem', fontWeight: 700}}>Email: mshieh53@gmail.com</Typography>
                        </Stack>

                        <Formik
                            initialValues={{
                                email: 'michelleshieh@gmail.com',
                                password: '',
                            }}
                        ...
                        >
                            <Form>
                                <Stack style={{}} alignItems="center" spacing={1}>
                                    {/* <Field as={CustomTextField} disabled={true} id="email" name="email" type="email" value="mshieh53@gmail.com"/> */}
                                    <Field as={CustomTextField} type="password" id="password" name="password" placeholder="Password" />
                                    <Field as={CustomTextField} type="password" id="password-confirm" name="password-confirm" placeholder="Confirm Password" />
