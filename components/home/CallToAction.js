...
export default function CallToAction({ mobile = false }) {
    ...
    const headlineStyle = { fontSize: mobile ? '2rem' : '3rem', textAlign: 'center', fontWeight: mobile ? 400 : 500 }
    ...
    return (
        <Stack spacing={3} style={{ marginTop: mobile ? '18%' : '8%', maxWidth: mobile ? "400px" : '580px' }}>
