...
export default function InstagramPost({ item, editMode = false, triggerReload, miniMode=false }) {
    ...
    const containerStyle = miniMode ? { position: 'relative', width: '100%', height: MINI_MODE_HEIGHT
    ...
    return (
        <Stack direction="column" alignItems="center" style={containerStyle}>
            ...
            <iframe src={`${uri}embed`} width="100%" frameBorder="0" scrolling="no" allowtransparency="true" style={igFrameStyle}></iframe>
