...
export const AlcoveSubmitButton = (props) => (
    <Button {...props} variant="contained" type="submit" style={{ textTransform: 'none', backgroundColor: props.disabled ? 'lightgrey' : HOME_THEME.primary, width: "100%", borderRadius: '0.5rem', marginTop: '1em' }} />
)
