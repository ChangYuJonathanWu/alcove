    ...
    it('can render new item modal and flow', () => {
        ...
        cy.get('[data-cy="new-item-selection-modal"]').should('exist').should('be.visible').within(() => {
            ...
            cy.get("[data-cy='list-item-form']").should('exist').within(() => {
                ...
                cy.get('[data-cy="list-item-form--submit-button"]').get("button").should('exist').should('be.disabled')
                ...
                cy.get('[data-cy="list-item-form--submit-button"]').get('button').should('exist').should('not.be','disabled')
